//static const String SketchName  = "BeckE32_AlexaTest.ino";
//static const String FileDate    = "December 2, 2018, Lenny-a";
//Derived from BeckE32_Alexa.ino but for only one relay, plan to merge to BeckE8266_Blynk.ino
#include <Arduino.h>
#ifdef ESP32
  #include <WiFi.h>
...
*/
  //#define RELAY_PIN_1  5		//NodeMCU pin D1 is GPIO 5
  #define RELAY_PIN_1  15		//NodeMCU pin D8 is GPIO 15
  //#define RELAY_PIN_2  4		//NodeMCU pin D2 is GPIO 4
#endif
