static const char szSketchName[]  = "BeckEspressifESP32_SDMMC_Test.ino";
static const char szFileDate[]    = "Oct 3, 2017, Lenny-c";
...
void setup(){
    ...
    //Serial << endl << "setup(): End " << szSketchName << ", " << szFileDate << endl;
}	//setup
