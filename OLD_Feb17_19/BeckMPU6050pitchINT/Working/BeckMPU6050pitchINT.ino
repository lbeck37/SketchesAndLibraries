String	acSketchName	= "BeckMPU6050pitchINT.ino, ";
String	acFileDate		= "Aug 5, 2017, Ace-M";
...
const unsigned long	ulGyroSpacingMsec		= 1000;
...
void setup() {
    ...
    Serial.begin(115200);
    //Serial.println(F("Setup(): Beck_MPU6050_DMP_Pitch.ino, 8/2/17 Ace-A"));
        ...
        fifoCount -= packetSize;
            ...
            Serial.println(euler[2] * 180/M_PI);
          	...
          	if (false || (ulCurrentMsec > ulNextGyroMsec)) {
            	...
            	BLog("loop(): fifoCount= ", mpu.getFIFOCount());
							// display Euler angles in degrees
							mpu.dmpGetQuaternion(&q, fifoBuffer);
							mpu.dmpGetGravity(&gravity, &q);
							mpu.dmpGetYawPitchRoll(ypr, &q, &gravity);
	          	BLog("loop(): Pitch= ", (ypr[1] * 180/M_PI));
/*
							Serial.print("ypr\t");
