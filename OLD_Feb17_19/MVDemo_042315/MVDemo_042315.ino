...
int sDoFontDemo(void) {
   ...
   sCursorY    = 40;
   bClearPage  = true;
   sDisplayText(bClearPage, sFontType, sCursorX, sCursorY, "  Font 0  ");
#else
   uView.clear(PAGE);
   uView.setCursor(0,40);
   uView.print("  Font 0  ");
   ...
   sCursorX    = 0;
   sCursorY    = 0;
   //sDisplayText(bClearPage, sFontType, sCursorX, sCursorY, "01234567890ABCDabcd01234567890ABCDabcd");
   sDisplayText(bClearPage, sFontType, sCursorX, sCursorY,   "Abcdef6789");
#if 0
   uView.setFontType(0);
   uView.setCursor(0,0);
   ...
   sCursorY    = 40;
   bClearPage  = true;
   sDisplayText(bClearPage, sFontType, sCursorX, sCursorY, "  Font 1  ");
#if 0
   uView.clear(PAGE);
   uView.setCursor(0,40);
   uView.print("  Font 1  ");
   ...
   sCursorY    = 0;
   bClearPage  = false;
   //sDisplayText(bClearPage, sFontType, sCursorX, sCursorY, "0123ABCDabcd");
   sDisplayText(bClearPage, sFontType, sCursorX, sCursorY,   "Abc4567");
#if 0
   uView.setFontType(1);
   uView.setCursor(0,0);
